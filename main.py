...
# st.title("Object Detection Using YOLOv5x")
...
#     #converting the image into nupy array and then into opencv format of image
...
#     results = model.predict(img_opencv,save = True)
...
#     st.image(img_opencv, caption="Processed Image", use_column_width=True)

#     st.download_button("Download",img_opencv)
